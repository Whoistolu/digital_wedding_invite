...
const milestones = [
  ...
  },
  {
    ...
    title: "First Date",
    description:
      "A quiet dinner by the waterfront. Shammah arrived with a single red rose and a nervous smile that Comfort found endearing. The evening stretched into midnight without either of them noticing.",
    icon: "♥",
  ...
  },
  {
    ...
    title: "The Proposal",
    description:
      "On a rooftop under a canopy of fairy lights, Shammah got down on one knee. Comfort said yes before he could finish the question. The city lights below felt like a standing ovation.",
    icon: "💍",
